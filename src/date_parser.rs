...
impl DateParser {
    ...
    pub fn might_be_date(value: &str) -> bool {
        ...
        let has_month_name = ["jan", "feb", "mar", "apr", "may", "jun",
...
mod tests {
    ...
    fn test_date_only_formats() {
        ...
        for case in cases {
            ...
            if let Some(Value::Date(dt)) = result {
                ...
                assert!(dt.month() == 12 || dt.day() == 25, 
                       "Date parsing failed for {}: got month={}, day={}", case, dt.month(), dt.day());
            }
        }
    }
    ...
    fn test_might_be_date_heuristics() {
        ...
        for case in positive_cases {
            assert!(DateParser::might_be_date(case), "{} should be detected as date-like", case);
        }
        ...
        for case in negative_cases {
            assert!(!DateParser::might_be_date(case), "{} should not be detected as date-like", case);
        }
    }
